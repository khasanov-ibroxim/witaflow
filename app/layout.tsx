...
export const metadata: Metadata = {
    ...
    keywords: [
        ...
        "bolalar vitamini", "Bolalar uchun vitaminlar ", "premium vitamin",
        "suspenziya vitamin", "zinc vitamin", "c vitamin",
    ],
    ...
    twitter: {
        ...
        description: "OsteoBalance, Baby Vita va Melatonin — ilmiy asosda ishlab chiqilgan premium vitamin suspenziyalari.",
        images: [`${siteUrl}/vf-logo.png`],
    },
    robots: {
        index: true,
        follow: true,
    ...
    "@graph": [
        {
            ...
            description: "Vitaflow Pharm — O'zbekistonda premium sifatli vitamin va mineral komplekslari ishlab chiqaruvchisi.",
            address: {
                "@type": "PostalAddress",
        ...
        },
        {
            ...
            url: siteUrl,
            name: "Vitaflow Pharm",
            description: "Premium vitamin va mineral komplekslari — OsteoBalance, Baby Vita, Melatonin",
        ...
        },
        {
            ...
            description: "OsteoBalance, Baby Vita va Melatonin — ilmiy asosda ishlab chiqilgan premium sifatli vitamin suspenziyalari.",
            inLanguage: "uz-UZ",
        },
        {
            "@type": "ItemList",
            ...
            itemListElement: [
                {
                    ...
                    item: {
                        "@type": "Product",
                        name: "OsteoBalance",
                        description: "Kaltsiy, Magniy, D3, Rux va C vitamini suspenziyasi — suyaklar mustahkamligi va immunitet uchun. 100 ml.",
                        url: `${siteUrl}/product/osteobalance/`,
                        image: `${siteUrl}/product.png`,
...
export default function RootLayout({
    ...
    return (
        ...
        <head>
            ...
            {/* Yandex Metrika badge ni yashirish */}
            <style dangerouslySetInnerHTML={{ __html: `#ym-badge,.ym-badge{display:none!important}` }} />
        </head>

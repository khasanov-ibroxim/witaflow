...
import productImage from "@/assets/osteobalance-product.png";

const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-gradient-emerald">
      {/* Decorative elements */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative">
              <div className="absolute inset-0 glow-gold rounded-full scale-75" />
              <motion.img
                src={productImage}
                alt="OsteoBalance - Kaltsiy, Magniy, D3, Sink va C vitamini suспензияси 100ml"
                className="relative z-10 w-64 sm:w-80 lg:w-96 drop-shadow-2xl"
                animate={{ y: [0, -15, 0] }}

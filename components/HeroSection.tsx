...
import productImage from "@/assets/logoRemoved.png";
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <p className="text-muted-foreground text-lg sm:text-xl max-w-lg mx-auto lg:mx-0 mb-8 font-body font-light leading-relaxed">
                            Vitaflow Pharm mutaxassislari tomonidan ishlab chiqilgan mahsulotlar Yevropa xomashyosi,
                            zamonaviy texnologiyalar va ilmiy tadqiqotlar asosida yaratiladi. Biz bolalar va kattalar
                            salomatligini qo‘llab-quvvatlash uchun samarali yechimlar yaratamiz.
                        </p>
                    ...
                    >
                      <div className="relative">
                        <div className="absolute inset-0  rounded-full scale-75" aria-hidden="true" />
                        <motion.div
                            animate={{ y: [0, -15, 0] }}

...
const AboutSection = () => {
  return (
    <section id="haqida" className="py-24 bg-secondary relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative w-72 h-72 sm:w-96 sm:h-96">
              <div className="absolute inset-0 rounded-3xl bg-gradient-card border border-gold shadow-gold" />
              <Image
                src={logoImage}
          ...
          >
            <span className="text-primary font-body text-sm tracking-widest uppercase">Kompaniya haqida</span>
            ...
            <p className="text-muted-foreground text-lg font-body font-light leading-relaxed mb-8">
              Biz sifat va ilmiy yondashuvga asoslangan mahsulotlar yaratamiz. 
              Har bir formulamiz mutaxassislar tomonidan ishlab chiqilgan va 
